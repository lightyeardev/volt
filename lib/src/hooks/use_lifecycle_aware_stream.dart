...
T useLifecycleAwareStream<T>(Stream<T> stream, {required T initialData, List<Object?>? keys}) =>
    use(_LifecyleAwareStreamHook<T>(stream, initialData: initialData, keys: keys));
